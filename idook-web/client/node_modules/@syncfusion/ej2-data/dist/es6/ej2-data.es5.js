...
var WebApiAdaptor = /** @__PURE__ @class */ (function (_super) {
    ...
    WebApiAdaptor.prototype.insert = function (dm, data, tableName, query) {
        return {
            ...
            data: JSON.stringify(extend({}, { value: data }, DataUtil.getAddParams(this, dm, query)))
        };
    };
    /**
     * Prepare and return request body which is used to remove record from the table.
    ...
    WebApiAdaptor.prototype.remove = function (dm, keyField, value, tableName, query) {
        return {
            ...
            data: JSON.stringify(extend({}, { key: value }, DataUtil.getAddParams(this, dm, query)))
        };
    };
    /**
     * Prepare and return request body which is used to update record.
    ...
    WebApiAdaptor.prototype.update = function (dm, keyField, value, tableName, query) {
        return {
            type: 'PUT',
            url: dm.dataSource.url,
            data: JSON.stringify(extend({}, { value: value }, DataUtil.getAddParams(this, dm, query)))
        };
    };
